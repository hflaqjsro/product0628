...
%>
	...
	<hr>
		...
		<form method="post" action="resumeEdit_update.jsp?rsNum=<%=rsNum %>" name="form1">
		<table width="650" border=1 align="center" cellspacing="0" cellpadding="5">
			...
			<tr>
				...
				<td><input type="text" name="rsTitle" size=30 style="width:450px;" value=<%=rsTitle %>></td>
			</tr>
			<tr>
				<td>사진</td>
			...
			<tr>
				...
				<td><input type="text" name="mobile" size=11 value="<%=mobile%>"></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><input type=submit value="수정 확인"></td>
			</tr>
		</table>
	</form>
